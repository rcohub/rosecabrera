// Source: Glass Shader from Alastair Aitchison - https://alastaira.wordpress.com/2013/12/21/glass-shader/
...
Shader "Custom/Transparent Specular" {
	Properties {
		...
		_ReflectBrightness ("Reflection Brightness", Float) = 0.3
		// Specular
		_SpecularMap ("Specular / Reflection Map", 2D) = "blue" {}
		// Rim
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			half intensity = 0.1 - saturate(dot (normalize(IN.viewDir), o.Normal));
